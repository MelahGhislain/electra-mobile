...
// import 'package:qleo/presentation/insights/bloc/insights_cubit.dart';
// import 'package:qleo/presentation/insights/bloc/insights_state.dart';
// import 'package:qleo/presentation/insights/widgets/insights_header.dart';
// import 'package:qleo/presentation/insights/widgets/insights_totals_card.dart';
// import 'package:qleo/presentation/insights/widgets/insights_top_categories.dart';
// import 'package:qleo/presentation/insights/widgets/insights_spending_overview.dart';
// import 'package:qleo/presentation/insights/widgets/insights_states.dart';
// import 'package:qleo/presentation/insights/widgets/insights_key_insights_grid.dart';
// import 'package:qleo/presentation/insights/widgets/insights_trend_section.dart';
// import 'package:qleo/presentation/insights/widgets/insights_bottom_row.dart';
...
import 'package:qleo/presentation/insights/widgets/insights_trend_section.dart';
import 'package:qleo/presentation/insights/widgets/insights_bottom_row.dart';
import 'package:qleo/presentation/insights/widgets/insights_health_score_card.dart';
import 'package:qleo/presentation/insights/widgets/insights_stat_cards_row.dart';
import 'package:qleo/presentation/insights/widgets/insights_top_spending_days.dart';
import 'package:qleo/presentation/insights/widgets/insights_recommendations.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:intl/intl.dart';
...
class _InsightsContentState extends State<_InsightsContent> {
  ...
  Widget build(BuildContext context) {
    final insights = widget.state.insights;
    final l = AppLocalizations.of(context);
    final isPremium = insights.isPremium;
    final aiEnrichment = insights.aiEnrichment;
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // ── PREMIUM: Financial health score ───────────────────────
            if (isPremium && aiEnrichment != null) ...[
              const SizedBox(height: 16),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16),
                child: InsightsHealthScoreCard(
            ...
            // ── PREMIUM: 4 quick-stat cards ───────────────────────────
            if (isPremium) ...[
              const SizedBox(height: 16),
              InsightsStatCardsRow(insights: insights),
            ],
            ...
            // ── Key insights (free) / replaced by AI cards (premium) ──
            if (!isPremium) ...[
              _SectionHeader(title: l.keyInsights),
              const SizedBox(height: 12),
              Padding(
            ...
            // ── PREMIUM: Top spending days + Recommendations ──────────
            if (isPremium && insights.topSpendingDays.isNotEmpty) ...[
              const SizedBox(height: 24),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16),
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    // Top spending days (left half)
                    Expanded(
                      child: InsightsTopSpendingDays(
                        days: insights.topSpendingDays,
                        currency: insights.totals.currency,
                      ),
                    ),
                  ],
            ...
            if (isPremium && aiEnrichment != null) ...[
              ...
              InsightsRecommendations(
                recommendations: aiEnrichment.recommendations,
                currency: insights.totals.currency,
              ),
            ],
            ...
            // ── Payment + Merchant + Savings row (both tiers) ─────────
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              child: InsightsBottomRow(
                paymentMethods: insights.paymentMethods,
...
// ── Overview section header with dropdown ─────────────────────────────────────
